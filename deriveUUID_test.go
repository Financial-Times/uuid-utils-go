...
func TestDeriveUUID_From_IsSuccessful(t *testing.T) {
...
func TestDeriveUUID_From_SameSaltSameResults(t *testing.T) {
...
func TestDeriveUUID_From_DifferentSaltsDifferentResults(t *testing.T) {
...
func TestDeriveUUID_Revert_UUIDIsReversible(t *testing.T) {
	originalUUID, _ := NewUUIDFromString("0000ea79-00a5-504e-a28d-11bd108b35ac")
...
func TestDeriveUUID_Revert_SameSaltSameResults(t *testing.T) {
	someUUID, _ := NewUUIDFromString("0000ea79-00a5-504e-a28d-11bd108b35ac")
...
func TestDeriveUUID_Revert_DifferentSaltsDifferentResults(t *testing.T) {
	someUUID, _ := NewUUIDFromString("0000ea79-00a5-504e-a28d-11bd108b35ac")
